...
const handlers = {
  ...
  'NextDeparture': function () {
    ...
    const airportChimeStartSound = '<audio src="https://s3-eu-west-1.amazonaws.com/lux-airport/AirportChimeStart.mp3" />';
    ...
    axios.get(nextDepartureURL).then((response) => {
        ...
        this.emit(':ask', `${airportChimeStartSound} ${e.message}`, 'What can I do for you?');
    });
  },
  ...
  'NextArrival': function () {
    ...
    axios.get(nextArrivalURL).then((response) => {
        ...
        const message = 'Next arrival is flight number <say-as interpret-as="characters">' +
